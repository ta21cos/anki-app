...
- **デッキ管理** — 複数デッキの作成、デッキ間マージ機能。Anki と同じ `親::子` 記法でデッキ名を付けると、一覧とセッション開始画面でグループとして折りたたまれる
...
- [チャンクをレベル別に分類して本番へ反映する手順](docs/chunk-level-classification.md)に、B1・B2・C1 の分類基準、フォルダーの命名、学習履歴を保持する移動、検証・復元の手順を記載しています。
